...
struct Student;	/* student.h:3 */
struct ns__helloResponse;	/* student.h:9 */
struct ns__hello;	/* student.h:9 */

/* student.h:3 */
#ifndef SOAP_TYPE_Student
#define SOAP_TYPE_Student (7)
/* complex XML schema type 'Student': */
...
#define SOAP_TYPE_ns__helloResponse (11)
/* complex XML schema type 'ns:helloResponse': */
struct SOAP_CMAC ns__helloResponse {
      public:
        /** Required element 'greeting' of XML schema type 'Student' */
        struct Student greeting;
      public:
...
#define SOAP_TYPE_ns__hello (12)
/* complex XML schema type 'ns:hello': */
struct SOAP_CMAC ns__hello {
      public:
        /** Required element 'name' of XML schema type 'Student' */
        struct Student name;
      public:
...
/* struct Student has binding name 'Student' for type 'Student' */
#ifndef SOAP_TYPE_Student
#define SOAP_TYPE_Student (7)
#endif
